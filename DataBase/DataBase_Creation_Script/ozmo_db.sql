...
-- 
-- Anamakine: localhost
-- Üretim Zamanı: 11 Mart 2015 saat 01:35:43
...
INSERT INTO `user` VALUES (0x6c6f63616c686f7374, 0x726f6f74, 0x2a45463832453737464634313834323039383538424441324338353344334437413538373044453830, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
...
-- Veritabanı: `ozmopol`
-- 
CREATE DATABASE `ozmopol` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ozmopol`;
...
CREATE TABLE `posts` (
  `pk_post_id` varchar(32) NOT NULL,
  `post_title` varchar(256) default NULL,
  `post_content` text NOT NULL,
  `post_c_date` datetime default NULL,
  `post_e_date` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
  `fk_post_user_id` varchar(32) NOT NULL,
  `fk_post_room_id` varchar(32) NOT NULL,
  `fk_post_prnt_id` varchar(32) default NULL,
  PRIMARY KEY  (`pk_post_id`),
  UNIQUE KEY `pk_post_id` (`pk_post_id`),
  KEY `fk_post_user_id` (`fk_post_user_id`),
  KEY `fk_post_room_id` (`fk_post_room_id`),
  KEY `fk_post_prnt_id` (`fk_post_prnt_id`)
...
INSERT INTO `posts` VALUES ('jdu5oxnwmoylyedr', 'Party at ma haus :D everyone invited... woop woop!!!', 'if you have nothin to do and passing by kadikoy, jus knock n join us. its 24 falan st. no 29. BYOB!!!', '2015-03-10 19:44:57', '2015-03-10 19:44:57', 'urb49ne9bek30mme', 'rrhysd276185jstf', NULL);
INSERT INTO `posts` VALUES ('lrncndhrkktnchw0', NULL, 'what time is the parteeey? ', '2015-03-10 19:44:59', '2015-03-10 19:44:59', 'bjkweshgk48y93s4', 'rrhysd276185jstf', 'jdu5oxnwmoylyedr');
INSERT INTO `posts` VALUES ('hhegdteuiwoodadr', NULL, 'anytime after 8 is fine... before 6 in the next morning ofcourse (6_6) ', '2015-03-10 19:45:00', '2015-03-10 19:45:00', 'urb49ne9bek30mme', 'rrhysd276185jstf', 'lrncndhrkktnchw0');
INSERT INTO `posts` VALUES ('krt74yehancleor8', NULL, 'awesome! count me in xoxo ', '2015-03-10 19:45:01', '2015-03-10 19:45:01', 'bjksefkhjw49ub43', 'rrhysd276185jstf', 'jdu5oxnwmoylyedr');
INSERT INTO `posts` VALUES ('63yehcldr24qy3er', NULL, 'woohoo... guess whos da DJ :D ', '2015-03-10 19:45:02', '2015-03-10 19:45:02', 'urb49ne9bek30mme', 'rrhysd276185jstf', 'krt74yehancleor8');
INSERT INTO `posts` VALUES ('blablabla8i3teh6', NULL, 'Probably maybe definitely ADAM hahahaaa', '2015-03-10 19:45:03', '2015-03-10 19:45:03', 'bjksefkhjw49ub43', 'rrhysd276185jstf', '63yehcldr24qy3er');
INSERT INTO `posts` VALUES ('polishnfnfojndkn', NULL, '...is it Adam?!!', '2015-03-10 19:45:03', '2015-03-10 19:45:03', 'bjkweshgk48y93s4', 'rrhysd276185jstf', '63yehcldr24qy3er');
INSERT INTO `posts` VALUES ('uejd[rotlzbah17f', NULL, 'Hahahaha who else could it be!', '2015-03-10 19:45:04', '2015-03-10 19:45:04', 'bjkweshgk48y93s4', 'rrhysd276185jstf', 'polishnfnfojndkn');
...
CREATE TABLE `rooms` (
  `pk_room_id` varchar(32) NOT NULL,
  `room_title` varchar(64) NOT NULL,
  `room_desc` text,
  PRIMARY KEY  (`pk_room_id`),
  UNIQUE KEY `pk_room_id` (`pk_room_id`),
  UNIQUE KEY `room_title` (`room_title`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `rooms` VALUES ('ffffffffffffffff', 'HALL', 'HALL');
INSERT INTO `rooms` VALUES ('3uh2gkejasdy9243', 'Dining Hall', 'Wahz cookin doc?');
INSERT INTO `rooms` VALUES ('uiybewg4jh3g4gbs', 'Shuttle Hour Updates', 'Shuttles come, Shuttles go, eat a tomato');
INSERT INTO `rooms` VALUES ('ju3hyd2762uytgds', 'Music Events', '... d(~_~)b... ');
INSERT INTO `rooms` VALUES ('rrhysd276185jstf', 'Party Nation', 'This is a serious room');
INSERT INTO `rooms` VALUES ('rakhsd2775632g4s', 'Lets Study', 'Seriously?! who the fu... Mom! Get of the internet!');
...
INSERT INTO `users` VALUES ('ffffffffffffffff', 'GOD', 'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 'god@ozu.edu.tr', '0000-00-00');
INSERT INTO `users` VALUES ('bjkweshgk48y93s4', 'Mosey', 'bjkweshgk48y93s4bjkweshgk48y93s4bjkweshgk48y93s4bjkweshgk48y93s4', 'mosey@ozu.edu.tr', '1100-01-01');
INSERT INTO `users` VALUES ('urb49ne9bek30mme', 'Abey', 'urb49ne9bek30mmeurb49ne9bek30mmeurb49ne9bek30mmeurb49ne9bek30mme', 'abey@ozu.edu.tr', '1000-01-01');
INSERT INTO `users` VALUES ('bjksefkhjw49ub43', 'Jesey', 'bjksefkhjw49ub43bjksefkhjw49ub43bjksefkhjw49ub43bjksefkhjw49ub43', 'jesey@ozu.edu.tr', '1200-01-01');

-- --------------------------------------------------------

-- 
-- Tablo yapısı: `vote_post`
-- 
...
-- 
-- Tablo döküm verisi `vote_post`
-- 

INSERT INTO `vote_post` VALUES ('sadsfasfasdas', 'adfasdfasdfasdf', 'asfasdasdasdas', 2, '2015-03-11 01:26:50');
INSERT INTO `vote_post` VALUES ('sadsfasfasd2as', 'adfa2sdfasdfasdf', 'asfa2sdasdasdas', 20, '2015-03-11 01:28:14');
INSERT INTO `vote_post` VALUES ('sadsfasfas3das', 'adfasdfa3sdfasdf', 'asfasdasdasd3as', 1, '2015-03-11 01:28:35');

-- --------------------------------------------------------

-- 
-- Tablo yapısı: `xt_user_room_sub`
-- 
...
-- 
-- Tablo döküm verisi `xt_user_room_sub`
-- 

INSERT INTO `xt_user_room_sub` VALUES ('afafrgadfasdf', 'afasfasdasda', '2015-03-11 01:35:07');

-- --------------------------------------------------------

-- 
-- Tablo yapısı: `xt_user_user_sub`
-- 
...
-- 
-- Tablo döküm verisi `xt_user_user_sub`
-- 

INSERT INTO `xt_user_user_sub` VALUES ('afsadasdasdas', 'sadasdasdasd', '2015-03-11 01:32:27');
-- 
...
-- 
-- Tablo döküm verisi `pma_bookmark`
-- 
...
-- 
-- Tablo döküm verisi `pma_history`
-- 
...
-- 
-- Tablo döküm verisi `pma_pdf_pages`
-- 
...
-- 
-- Tablo döküm verisi `pma_relation`
-- 
...
-- 
-- Tablo döküm verisi `pma_table_coords`
-- 
...
-- 
-- Tablo döküm verisi `pma_table_info`
-- 
